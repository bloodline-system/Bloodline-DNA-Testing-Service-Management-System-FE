...
- Name: order\order-list.spec.ts >> Order Management API >> TC-ORD-01: GET /v1/manager/orders returns valid order list structure
- Location: tests\order\order-list.spec.ts:14:3
