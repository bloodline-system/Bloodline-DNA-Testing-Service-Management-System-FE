                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="max-w-2xl text-sm leading-6 text-slate-600 md:text-base">
                      Search titles, organize categories, upload featured
                      images, and publish content from one place.
                    </p>
                  </div>
                ...
                <div className="rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,_rgba(255,255,255,0.95),_rgba(241,245,249,0.95))] p-5 shadow-lg shadow-slate-200/60">
                  ...
                  <div className="mt-5 grid gap-3 text-sm text-slate-600">
                    <div className="rounded-2xl border border-slate-200 bg-white/80 px-4 py-3">
                      File upload is handled before saving so the post payload
                      stays lean.
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-white/80 px-4 py-3">
                      Search is title-based to keep result filtering
                      predictable.
                    </div>
                  </div>
                </div>
                        ...
                        <CardContent className="space-y-4 p-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                void handlePublish(post, "PUBLISHED")
                              }
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                void handlePublish(post, "ARCHIVED")
                              }
                              disabled={updateStatusMutation.isPending}
                            >
                              Archive
              ...
              <aside className="space-y-4">
                <Card className="sticky top-24 border-slate-200/80 bg-white/95 shadow-xl shadow-slate-200/70 backdrop-blur">
                  <CardHeader className="border-b border-slate-100 bg-gradient-to-r from-indigo-50 via-white to-sky-50">
                    ...
                    <CardDescription>
                      Use the editor to draft content or adjust an existing
                      post.
                    </CardDescription>
                  </CardHeader>
