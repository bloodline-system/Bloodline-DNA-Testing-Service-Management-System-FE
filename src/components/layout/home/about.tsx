...
const About = ({
  ...
  return (
    <section
      className={cn(
        "py-24 bg-gradient-to-b  to-white dark:from-slate-900 dark:to-background",
        className,
      )}
    >
      <div className="container">
        <div className="mb-14 flex flex-col items-center text-center gap-5 mx-auto max-w-3xl">
